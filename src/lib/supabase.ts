...
/**
 * Service-role client — bypasses RLS entirely. NEVER import this in any
 * file that ships to the client. Only for trusted server code: webhook
 * handlers, admin actions, cron jobs.
 */
